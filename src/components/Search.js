...
function Search({hideButtons= false}) {
    ...
    const history = useHistory(); //This provides us with the browsers history
    ...
    const search = (e) => {
        ...
        // do somethimg with input.... come back and fix
        history.push("./search"); //routing to search page
    }
    return (
